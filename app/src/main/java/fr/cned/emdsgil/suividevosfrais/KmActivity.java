/**
 * Fichier de définition de la classe KmActivity
 *
 * @author CNED
...
/**
 * Gestion des éléménts forfaitisés "KM"
 */
public class KmActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.editText      = (EditText)findViewById((R.id.txtKm));
		this.datePicker    = (DatePicker)findViewById(R.id.datKm);
		this.imgReturn     = (ImageView)findViewById(R.id.imgKmReturn);
		this.cmdBtnPlus    = (Button)findViewById(R.id.cmdKmPlus);
		this.cmdBtnMoins   = (Button)findViewById(R.id.cmdKmMoins);
		this.cmdBtnValider = (Button)findViewById(R.id.cmdKmValider);
		this.pas           = 10;
		this.context       = KmActivity.this;
	...
	private void cmdValider_clic() {
		cmdBtnValider.setOnClickListener(new Button.OnClickListener() {
			public void onClick(View v) {
			accesLocal.setFraisForfait(Global.getCleMois(annee, mois), "KM", qte, Global.getNow());
			retourActivityPrincipale() ;
			}
		}) ;
	}
