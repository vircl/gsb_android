/**
 * Fichier de définition de la classe EtapeActivity
 *
 * @author CNED
...
/**
 * Gestion des éléments forfaitisés "ETAPE"
 */
public class EtapeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.editText      = (EditText)findViewById((R.id.txtEtape));
        this.datePicker    = (DatePicker)findViewById(R.id.datEtape);
        this.imgReturn     = (ImageView)findViewById(R.id.imgEtapeReturn);
        this.cmdBtnPlus    = (Button)findViewById(R.id.cmdEtapePlus);
        this.cmdBtnMoins   = (Button)findViewById(R.id.cmdEtapeMoins);
        this.cmdBtnValider = (Button)findViewById(R.id.cmdEtapeValider);
        this.pas           = 1;
        this.context       = EtapeActivity.this;
    ...
    private void cmdValider_clic() {
        cmdBtnValider.setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
            accesLocal.setFraisForfait(Global.getCleMois(annee, mois), "ETP", qte, Global.getNow());
            retourActivityPrincipale() ;
            }
        }) ;
    }
